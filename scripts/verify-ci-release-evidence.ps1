...
foreach($gate in @('migrationBaseline','documentation','frontend','android','androidEmulator','backend','postgresqlIntegration','performanceBaseline')){if($e.gates.$gate-ne'passed'){$failures.Add("CI gate not passed: $gate")}}
