...
Write-Host 'PASS: Android release contracts and blocking 2.2.4-to-current AVD upgrade are wired; formal release evidence switches remain independently enforceable'
