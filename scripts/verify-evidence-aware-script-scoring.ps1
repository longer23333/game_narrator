...
Require 'src/main/java/cn/longer233/gamenarrator/quality/NarrativeConsistencyService.java' @('EVIDENCE_COVERAGE','getVisualAnalysisPath','getTranscriptJsonPath','evidenceCoverage < .5','supportedSegments')
Require 'src/main/java/cn/longer233/gamenarrator/quality/NarrativeQualityReport.java' @('supportedSegmentCount','segmentCount','evidenceCoverage')
