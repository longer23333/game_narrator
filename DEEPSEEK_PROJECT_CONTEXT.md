...
> 自动生成：2026-08-13 14:51:27 +08:00；UTF-8 BOM；索引不再内嵌全部源码。
> Git：分支 `unknown`，提交 `unknown`；收录文件 838 个，分卷 8 个。
...
| `deepseek-context/03-tests.md` | 113 | 379640 | Spring 测试与行为验证 |
| `deepseek-context/04-frontend.md` | 39 | 556813 | Vite Web 源码 |
| `deepseek-context/05-android-main.md` | 143 | 883601 | Android 实现、资源与 Gradle |
| `deepseek-context/06-android-tests.md` | 58 | 137159 | Android 单元及设备测试 |
| `deepseek-context/07-platform-release.md` | 12 | 73741 | Windows、CI/CD 与发布 |
| `deepseek-context/08-docs-scripts.md` | 85 | 283288 | 需求、架构、维护脚本 |
