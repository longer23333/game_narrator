...
> 自动生成：2026-08-12 15:12:43 +08:00；UTF-8 BOM；索引不再内嵌全部源码。
> Git：分支 `main`，提交 `02a182b`；收录文件 769 个，分卷 8 个。
...
| `deepseek-context/02-backend.md` | 285 | 1114780 | Spring 后端实现 |
| `deepseek-context/03-tests.md` | 96 | 297772 | Spring 测试与行为验证 |
...
| `deepseek-context/08-docs-scripts.md` | 62 | 224287 | 需求、架构、维护脚本 |
...
?? src/main/java/cn/longer233/gamenarrator/pipeline/StageCheckpointService.java
?? src/test/java/cn/longer233/gamenarrator/pipeline/StageCheckpointServiceTest.java
```
