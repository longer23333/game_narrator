...
> 自动生成：2026-08-13 10:03:44 +08:00；UTF-8 BOM；索引不再内嵌全部源码。
> Git：分支 `unknown`，提交 `unknown`；收录文件 799 个，分卷 8 个。
...
| 分卷 | 文件数 | 字符数 | 建议用途 |
|---|---:|---:|---|
| `deepseek-context/01-foundation.md` | 88 | 219430 | 构建、配置、资源、数据库迁移 |
| `deepseek-context/02-backend.md` | 296 | 1198244 | Spring 后端实现 |
| `deepseek-context/03-tests.md` | 106 | 338964 | Spring 测试与行为验证 |
| `deepseek-context/04-frontend.md` | 38 | 546876 | Vite Web 源码 |
...
| `deepseek-context/07-platform-release.md` | 12 | 60348 | Windows、CI/CD 与发布 |
| `deepseek-context/08-docs-scripts.md` | 67 | 236350 | 需求、架构、维护脚本 |
