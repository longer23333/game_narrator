...
> 自动生成：2026-08-14 16:21:41 +08:00；UTF-8 BOM；索引不再内嵌全部源码。
> Git：分支 `main`，提交 `2e4cafe`；收录文件 835 个，分卷 8 个。
...
| `deepseek-context/04-frontend.md` | 36 | 559020 | Vite Web 源码 |
| `deepseek-context/05-android-main.md` | 144 | 887366 | Android 实现、资源与 Gradle |
| `deepseek-context/06-android-tests.md` | 59 | 143956 | Android 单元及设备测试 |
| `deepseek-context/07-platform-release.md` | 13 | 83601 | Windows、CI/CD 与发布 |
| `deepseek-context/08-docs-scripts.md` | 78 | 275309 | 需求、架构、维护脚本 |
...
M .github/workflows/ci.yml
 ...
 D scripts/verify-event-driven-frame-sampling.ps1
 D scripts/verify-evidence-aware-script-scoring.ps1
 D scripts/verify-licensed-sfx-library.ps1
 D scripts/verify-local-model-management.ps1
 D scripts/verify-meme-timeline-slots.ps1
 D scripts/verify-release-readiness.ps1
 D scripts/verify-render-work-cleanup.ps1
 D scripts/verify-speaker-diarization.ps1
 D scripts/verify-startup-reconciliation.ps1
 D scripts/verify-task-cancellation-closure.ps1
 D scripts/verify-timeline-transitions.ps1
 D scripts/verify-ui-action-clarity.ps1
