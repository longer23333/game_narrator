...
> 自动生成：2026-08-11 11:34:56 +08:00；UTF-8 BOM；索引不再内嵌全部源码。
> Git：分支 `main`，提交 `472b7d8`；收录文件 696 个，分卷 8 个。
...
| 分卷 | 文件数 | 字符数 | 建议用途 |
|---|---:|---:|---|
| `deepseek-context/01-foundation.md` | 78 | 119860 | 构建、配置、资源、数据库迁移 |
| `deepseek-context/02-backend.md` | 258 | 1027135 | Spring 后端实现 |
| `deepseek-context/03-tests.md` | 81 | 227199 | Spring 测试与行为验证 |
| `deepseek-context/04-frontend.md` | 17 | 359257 | Vite Web 源码 |
...
| `deepseek-context/08-docs-scripts.md` | 46 | 174436 | 需求、架构、维护脚本 |
