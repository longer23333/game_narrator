...
> 自动生成：2026-08-13 10:50:16 +08:00；UTF-8 BOM；索引不再内嵌全部源码。
> Git：分支 `unknown`，提交 `unknown`；收录文件 809 个，分卷 8 个。
...
| `deepseek-context/02-backend.md` | 297 | 1217073 | Spring 后端实现 |
| `deepseek-context/03-tests.md` | 110 | 351703 | Spring 测试与行为验证 |
...
| `deepseek-context/07-platform-release.md` | 12 | 60692 | Windows、CI/CD 与发布 |
| `deepseek-context/08-docs-scripts.md` | 70 | 242193 | 需求、架构、维护脚本 |
