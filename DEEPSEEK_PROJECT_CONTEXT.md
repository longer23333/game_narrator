...
> 自动生成：2026-08-14 12:50:48 +08:00；UTF-8 BOM；索引不再内嵌全部源码。
> Git：分支 `main`，提交 `3ee17a1`；收录文件 845 个，分卷 8 个。
...
| `deepseek-context/04-frontend.md` | 39 | 560234 | Vite Web 源码 |
| `deepseek-context/05-android-main.md` | 144 | 886735 | Android 实现、资源与 Gradle |
| `deepseek-context/06-android-tests.md` | 59 | 143956 | Android 单元及设备测试 |
| `deepseek-context/07-platform-release.md` | 13 | 81884 | Windows、CI/CD 与发布 |
| `deepseek-context/08-docs-scripts.md` | 86 | 288842 | 需求、架构、维护脚本 |
