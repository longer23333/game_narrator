...
public final class MobileReleaseNotes {
    ...
    public static List<Note> notes() {
        ...
        notes.add(new Note("2.2.53", "发布门禁与状态一致性修复",
                "同步更新各平台版本，完成对应功能修复、稳定性检查与发布记录。"));
        notes.add(new Note("2.2.52", "安全与数据隔离加固",
                "同步更新各平台版本，完成对应功能修复、稳定性检查与发布记录。"));
        ...
        notes.add(new Note("2.2.37", "单实现模型适配层精简",
                "同步更新各平台版本，完成对应功能修复、稳定性检查与发布记录。"));
        notes.add(new Note("2.2.36", "流水线阶段状态统一",
                "同步更新各平台版本，完成对应功能修复、稳定性检查与发布记录。"));
        notes.add(new Note("2.2.35", "运行配置项收敛",
                "同步更新各平台版本，完成对应功能修复、稳定性检查与发布记录。"));
        notes.add(new Note("2.2.34", "验证脚本与持续集成精简",
                "同步更新各平台版本，完成对应功能修复、稳定性检查与发布记录。"));
        notes.add(new Note("2.2.33", "前端模块加载链路精简",
                "同步更新各平台版本，完成对应功能修复、稳定性检查与发布记录。"));
        ...
        notes.add(new Note("2.2.22", "稳定性与功能更新",
                "同步更新各平台版本，完成对应功能修复、稳定性检查与发布记录。"));
        notes.add(new Note("2.2.21", "稳定性与功能更新",
                "同步更新各平台版本，完成对应功能修复、稳定性检查与发布记录。"));
        notes.add(new Note("2.2.20", "稳定性与功能更新",
                "同步更新各平台版本，完成对应功能修复、稳定性检查与发布记录。"));
        notes.add(new Note("2.2.19", "稳定性与功能更新",
                "同步更新各平台版本，完成对应功能修复、稳定性检查与发布记录。"));
