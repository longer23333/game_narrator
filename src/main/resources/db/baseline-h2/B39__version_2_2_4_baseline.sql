-- Generated H2 baseline through V39. Do not edit; run scripts/build-migration-baselines.ps1.
...
-- source: V40__meme_timeline_slots.sql
...
CREATE TABLE IF NOT EXISTS director_edit_decisions (
    ...
    ai_value_json CLOB NOT NULL,
    final_value_json CLOB NOT NULL,
...
ALTER TABLE external_asset ADD CONSTRAINT IF NOT EXISTS fk_external_asset_owner FOREIGN KEY(owner_id) REFERENCES app_user(id);
...
CREATE TABLE ai_director_review (
    ...
    moderator_summary CLOB,
    consensus_score DECIMAL(5,4),
    final_decision_json CLOB,
    user_action VARCHAR(20),
    user_modification CLOB,
    input_tokens BIGINT NOT NULL DEFAULT 0,
    output_tokens BIGINT NOT NULL DEFAULT 0,
    estimated_cost DECIMAL(18,8) NOT NULL DEFAULT 0,
...
CREATE TABLE ai_director_message (
    ...
    cited_event_ids CLOB NOT NULL DEFAULT '[]',
    cited_clip_indexes CLOB NOT NULL DEFAULT '[]',
    cited_knowledge_refs CLOB NOT NULL DEFAULT '[]',
    input_tokens BIGINT NOT NULL DEFAULT 0,
    output_tokens BIGINT NOT NULL DEFAULT 0,
    elapsed_ms BIGINT NOT NULL DEFAULT 0,
    model_version VARCHAR(160),
