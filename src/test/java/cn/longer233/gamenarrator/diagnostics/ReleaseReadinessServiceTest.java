...
class ReleaseReadinessServiceTest {
 ...
 @Test void copiedOldOrWrongCommitEvidenceCannotBecomeGreen() throws Exception {
  ...
  String gates="\"migrationBaseline\":\"passed\",\"documentation\":\"passed\",\"frontend\":\"passed\",\"android\":\"passed\",\"androidEmulator\":\"passed\",\"backend\":\"passed\",\"postgresqlIntegration\":\"passed\",\"performanceBaseline\":\"passed\",\"longVideoPerformance\":\"passed\"";
  Files.writeString(root.resolve("artifacts/ci-release-result.json"),"{\"schemaVersion\":2,\"status\":\"passed\",\"commit\":\"2222222222222222222222222222222222222222\",\"runUrl\":\"https://github.com/a/b/actions/runs/1\",\"completedAt\":\""+Instant.now()+"\",\"gates\":{"+gates+"}}");
